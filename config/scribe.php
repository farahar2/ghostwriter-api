...
return [
    ...
    'auth' => [
        ...
        'extra_info' => 'Authenticate using a Bearer token obtained from <code>POST /api/auth/login</code> or <code>POST /api/auth/register</code>. Include the token in the <code>Authorization</code> header as <code>Bearer {token}</code>.',
    ],
